        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="grid grid-cols-4 gap-0 justify-center">
            <Card
              ...
              price={1000}
              covers={toppKasko}
              setSelectedCoverage={() => setSelectedCoverage("Toppkasko")}
            ...
            <Card
              ...
              price={1000}
              covers={kasko}
              setSelectedCoverage={() => setSelectedCoverage("Kasko")}
              selectedCoverage={selectedCoverage}
            />
            <Card
              title="Delkasko"
              price={1000}
              covers={delKasko}
              setSelectedCoverage={() => setSelectedCoverage("Delkasko")}
              selectedCoverage={selectedCoverage}
            />
            <Card
              title="Ansvar"
              price={1000}
              covers={ansvar}
              setSelectedCoverage={() => setSelectedCoverage("Ansvar")}
              selectedCoverage={selectedCoverage}
            />
          </div>
        </div>
